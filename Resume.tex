...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {CodeRobin}{Oxford, UK}
      {Intern}{Aug. 2019 - Current}
      \resumeItemListStart
      	\resumeItem{}
          {Led a team of 2 through part of Google's Widevine L1 certification process for an android tablet}
      \resumeItemListEnd
        \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{}  
          {Implemented spell check functionality by integrating an in-house search engine}
        \resumeItem{}
