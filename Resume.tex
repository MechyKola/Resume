...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Scotland Yard}{}
      {Object Orientated Programming (Java) Coursework}{}
      \resumeItemListStart
        \resumeItem{}
          {Completed part of Scotland Yard simulator using OOP techniques such as Double dispatch and Factory}
      \resumeItemListEnd
    \resumeSubheading
      {Reaction Training Game}{\href{https://github.com/MechyKola/ClickingCircles}
      {github.com/MechyKola/ClickingCircles}}
      {A level Computer Science Coursework}{\href{https://clickyeet.herokuapp.com/}
      {https://clickyeet.herokuapp.com/}}
      \resumeItemListStart
        \resumeItem{}
          {Vue.js, Vuex \& Vuetify.js frontend, Python \& Flask API, Heroku Postgres Database}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
