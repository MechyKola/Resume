...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
	  ...
	  \resumeItemListStart
        \resumeItem{}
          {A*A*AAB in Mathematics, Russian, Computer Science, Physics, Further Mathematics}
      \resumeItemListEnd
...
\section{Skills}
  ...
  \textbf{Technologies}{ Vue.js, Git, Github, Flask, Microsoft bot framework (previously used)} \\
