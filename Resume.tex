...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}c@{\extracolsep{\fill}}r}
  ...
  UK \& Ukraine Citizen & +44 7413766103 & \href{https://www.linkedin.com/in/mykolan}
...
%--------SKILLS------------
\section{Skills}
  \textbf{Languages}{ Python, C, Go, C\#, JavaScript, Haskell} \\
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{}
          {Memory sharing between goroutines, each processing a vertical strip of the worker's horizontal strip}
        \resumeItem{}
