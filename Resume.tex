  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{UkrSoc}{Social Secretary}
        \resumeItemListEnd
      \resumeSubheading
...
%--------SKILLS------------
\section{Skills}
  \textbf{Languages}{ Python, C, Haskell, JavaScript, Go (Golang), C\#, Java (decreasing preference)} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
      	\resumeItem{}
          {Developed a React application to retrieve, view and edit bond information}
        \resumeItem{}
          {Used websockets and React-vis to display graphs of real time data streams}
        \resumeItem{}
          {Created a full stack logs monitor using Go and React, allowing at-a-glance performance monitoring}
      \resumeItemListEnd
    \resumeSubheading
